...
<qgis labelsEnabled="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms" readOnly="0" version="3.16.9-Hannover">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Regular" fontSizeUnit="Point" capitalization="0" fontWeight="50" textColor="0,0,0,255" allowHtml="0" fontStrikeout="0" useSubstitutions="0" fontSize="7" fontKerning="1" textOpacity="1" previewBkgrdColor="255,255,255,255" multilineHeight="1" fieldName="'dist_calc_points: ' || round(dist_calc_points) || ' m'" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="1" textOrientation="horizontal" fontWordSpacing="0" fontFamily="MS Gothic" fontUnderline="0" fontLetterSpacing="0" fontItalic="0" blendMode="0">
      ...
      <placement overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" repeatDistance="0" overrunDistanceUnit="MM" lineAnchorType="0" placementFlags="11" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" yOffset="0" geometryGeneratorEnabled="0" geometryGeneratorType="PointGeometry" offsetType="0" polygonPlacementFlags="2" offsetUnits="MapUnit" distUnits="MM" centroidWhole="0" rotationAngle="0" preserveRotation="1" xOffset="0" lineAnchorPercent="0.5" repeatDistanceUnits="MM" priority="5" maxCurvedCharAngleOut="-25" overrunDistance="0" layerType="LineGeometry" geometryGenerator="" centroidInside="0" placement="3"/>
      <rendering obstacle="1" minFeatureSize="0" maxNumLabels="2000" fontMinPixelSize="3" fontLimitPixelSize="0" scaleMin="1" drawLabels="1" displayAll="0" obstacleType="0" scaleMax="5000" zIndex="0" scaleVisibility="1" upsidedownLabels="0" obstacleFactor="1" limitNumLabels="0" labelPerPart="0" fontMaxPixelSize="10000" mergeLines="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option type="Map" name="properties">
  ...
  <expressionfields/>
  <editform tolerant="1">C:/Users/lukas/AppData/Roaming/QGIS/QGIS3\profiles\default/python/plugins\threedi_schematisation_editor\forms\ui\channel.ui</editform>
