...
<qgis><attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="crest_type" />
      <column width="-1" hidden="0" type="field" name="discharge_coefficient_positive" />
      <column width="-1" hidden="0" type="field" name="discharge_coefficient_negative" />
      <column width="-1" hidden="0" type="field" name="friction_value" />
      <column width="-1" hidden="0" type="field" name="friction_type" />
      <column width="-1" hidden="0" type="field" name="sewerage" />
