...
<qgis maxScale="0" symbologyReferenceScale="-1" labelsEnabled="0" simplifyDrawingTol="1" simplifyDrawingHints="1" version="3.28.5-Firenze" simplifyMaxScale="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" readOnly="0" simplifyLocal="1" minScale="0">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style multilineHeight="1" fontItalic="0" multilineHeightUnit="Percentage" previewBkgrdColor="255,255,255,255" textOpacity="1" namedStyle="Standaard" useSubstitutions="0" textColor="0,0,0,255" blendMode="0" fontSizeUnit="Point" fieldName="ROWID" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" fontSize="8.25" fontLetterSpacing="0" forcedBold="0" isExpression="0" fontKerning="1" fontWordSpacing="0" legendString="Aa" fontFamily="MS Shell Dlg 2" fontWeight="50" forcedItalic="0" fontUnderline="0" fontStrikeout="0" allowHtml="0" capitalization="0">
        <families/>
        <text-buffer bufferDraw="0" bufferNoFill="0" bufferJoinStyle="64" bufferBlendMode="0" bufferColor="255,255,255,255" bufferSize="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1"/>
      ...
      <placement priority="5" lineAnchorPercent="0.5" rotationUnit="AngleDegrees" placementFlags="10" overrunDistance="0" lineAnchorType="0" geometryGeneratorType="PointGeometry" centroidInside="0" layerType="LineGeometry" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" lineAnchorTextPoint="CenterOfText" placement="2" distUnits="MM" fitInPolygonOnly="0" quadOffset="4" xOffset="0" geometryGenerator="" offsetType="0" polygonPlacementFlags="2" repeatDistance="0" allowDegraded="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" offsetUnits="MapUnit" maxCurvedCharAngleOut="-20" rotationAngle="0" overlapHandling="PreventOverlap" maxCurvedCharAngleIn="20" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorClipping="0" geometryGeneratorEnabled="0" yOffset="0" repeatDistanceUnits="MM" centroidWhole="0" preserveRotation="1"/>
