...
<qgis labelsEnabled="0" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" maxScale="0" symbologyReferenceScale="-1" version="3.28.5-Firenze" simplifyLocal="1" readOnly="0" simplifyDrawingTol="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" fontItalic="0" textOpacity="1" fontKerning="1" legendString="Aa" fontUnderline="0" multilineHeight="1" textOrientation="horizontal" fontSizeUnit="Point" fontFamily="MS Shell Dlg 2" fontWordSpacing="0" forcedItalic="0" fontSize="8.25" multilineHeightUnit="Percentage" useSubstitutions="0" fontStrikeout="0" fontWeight="50" namedStyle="Standaard" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fieldName="ROWID" allowHtml="0" forcedBold="0" fontLetterSpacing="0" isExpression="0" textColor="0,0,0,255" blendMode="0">
        <families/>
        <text-buffer bufferColor="255,255,255,255" bufferBlendMode="0" bufferSize="1" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferJoinStyle="64" bufferOpacity="1" bufferDraw="0"/>
      ...
      <placement geometryGenerator="" lineAnchorPercent="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" fitInPolygonOnly="0" maxCurvedCharAngleIn="20" centroidWhole="0" preserveRotation="1" yOffset="0" centroidInside="0" maxCurvedCharAngleOut="-20" rotationAngle="0" repeatDistanceUnits="MM" xOffset="0" lineAnchorType="0" quadOffset="4" overlapHandling="PreventOverlap" geometryGeneratorEnabled="0" distUnits="MM" lineAnchorClipping="0" priority="5" polygonPlacementFlags="2" layerType="LineGeometry" offsetType="0" geometryGeneratorType="PointGeometry" dist="0" placement="2" offsetUnits="MapUnit" allowDegraded="0" placementFlags="10" lineAnchorTextPoint="CenterOfText" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0"/>
