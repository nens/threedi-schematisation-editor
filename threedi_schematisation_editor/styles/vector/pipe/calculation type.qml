...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" minScale="0" labelsEnabled="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingTol="1" simplifyDrawingHints="1" maxScale="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories" symbologyReferenceScale="-1">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1" attr="calculation_type" type="categorizedSymbol">
    <categories>
      <category value="0" render="true" symbol="0" label="Embedded"/>
      <category value="1" render="true" symbol="1" label="Isolated"/>
      <category value="2" render="true" symbol="2" label="Connected"/>
      <category value="" render="true" symbol="3" label="Invalid"/>
    </categories>
    <symbols>
