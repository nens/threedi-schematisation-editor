...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" minScale="0" labelsEnabled="1" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingTol="1" simplifyDrawingHints="1" maxScale="0" version="3.22.10-Białowieża" styleCategories="AllStyleCategories" symbologyReferenceScale="-1">
    ...
    <symbols>
      ...
      <symbol clip_to_extent="1" name="1" alpha="1" force_rhr="0" type="line">
        ...
        <layer pass="0" class="MarkerLine" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@1@1" alpha="1" force_rhr="0" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" name="3" alpha="1" force_rhr="0" type="line">
        ...
        <layer pass="0" class="MarkerLine" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@3@1" alpha="1" force_rhr="0" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" name="4" alpha="1" force_rhr="0" type="line">
        ...
        <layer pass="0" class="MarkerLine" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@4@1" alpha="1" force_rhr="0" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" name="5" alpha="1" force_rhr="0" type="line">
        ...
        <layer pass="0" class="MarkerLine" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@5@2" alpha="1" force_rhr="0" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" name="8" alpha="1" force_rhr="0" type="line">
        ...
        <layer pass="0" class="MarkerLine" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@8@1" alpha="1" force_rhr="0" type="marker">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{b00e1947-9002-470a-a8d3-688baa326ad6}">
      <rule description="Start point label" scalemaxdenom="1000" key="{9a71fa29-518c-4f70-9582-4a8ad4a4cc0a}">
        <settings calloutType="simple">
          <text-style fontFamily="MS Gothic" fontSize="7" fieldName="'    s:' || coalesce(format_number(round(invert_level_start_point,2),2), 'NULL')" namedStyle="Regular" fontWeight="50" fontStrikeout="0" allowHtml="0" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" blendMode="0" fontSizeUnit="Point" textColor="0,0,223,255" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="1" fontItalic="0" fontWordSpacing="0" textOrientation="horizontal" useSubstitutions="0" capitalization="0" legendString="Aa" fontKerning="1" fontUnderline="0" textOpacity="1">
            <families/>
            <text-buffer bufferDraw="1" bufferBlendMode="0" bufferColor="255,255,255,255" bufferNoFill="0" bufferSizeUnits="MM" bufferOpacity="1" bufferSize="0.69999999999999996" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
          ...
          <placement dist="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" polygonPlacementFlags="2" distUnits="MM" lineAnchorPercent="0.5" quadOffset="4" lineAnchorClipping="0" yOffset="0" centroidWhole="0" offsetType="0" repeatDistanceUnits="MM" fitInPolygonOnly="0" repeatDistance="0" placement="2" layerType="LineGeometry" preserveRotation="0" lineAnchorType="0" xOffset="0" placementFlags="2" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" geometryGenerator="" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" geometryGeneratorEnabled="0" overrunDistance="0" rotationAngle="0" maxCurvedCharAngleIn="25" priority="5" overrunDistanceUnit="MM"/>
          <rendering upsidedownLabels="0" scaleMin="1" obstacleFactor="1" drawLabels="1" displayAll="1" unplacedVisibility="0" scaleVisibility="0" obstacle="1" fontMinPixelSize="3" zIndex="0" fontLimitPixelSize="0" scaleMax="10000000" obstacleType="0" minFeatureSize="0" mergeLines="0" fontMaxPixelSize="10000" labelPerPart="0" limitNumLabels="0" maxNumLabels="2000"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties" type="Map">
      ...
      <rule description="End point label" scalemaxdenom="1000" key="{cbf7c748-51a9-47f2-bf58-ad9c2245f9ab}">
        <settings calloutType="simple">
          <text-style fontFamily="MS Gothic" fontSize="7" fieldName="'e:'||coalesce(format_number(round(invert_level_end_point,2),2), 'NULL')|| '    '" namedStyle="Regular" fontWeight="50" fontStrikeout="0" allowHtml="0" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" blendMode="0" fontSizeUnit="Point" textColor="255,119,0,255" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="1" fontItalic="0" fontWordSpacing="0" textOrientation="horizontal" useSubstitutions="0" capitalization="0" legendString="Aa" fontKerning="1" fontUnderline="0" textOpacity="1">
            <families/>
            <text-buffer bufferDraw="1" bufferBlendMode="0" bufferColor="255,255,255,255" bufferNoFill="0" bufferSizeUnits="MM" bufferOpacity="1" bufferSize="0.69999999999999996" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
            <text-mask maskSizeUnits="MM" maskType="0" maskOpacity="1" maskJoinStyle="128" maskSize="0" maskEnabled="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers=""/>
            <background shapeRadiiX="0" shapeSizeY="0" shapeRadiiUnit="MM" shapeSVGFile="" shapeRotation="0" shapeBlendMode="0" shapeSizeUnit="MM" shapeOpacity="1" shapeDraw="0" shapeOffsetX="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeBorderWidthUnit="MM" shapeSizeType="0" shapeOffsetY="0" shapeFillColor="255,255,255,255" shapeBorderWidth="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeRadiiY="0" shapeRotationType="0" shapeSizeX="0" shapeBorderColor="128,128,128,255" shapeJoinStyle="64">
          ...
          <text-format leftDirectionSymbol="&lt;" addDirectionSymbol="0" rightDirectionSymbol=">" multilineAlign="0" decimals="3" wrapChar="" autoWrapLength="0" placeDirectionSymbol="0" formatNumbers="0" useMaxLineLengthForAutoWrap="1" plussign="0" reverseDirectionSymbol="0"/>
          <placement dist="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" polygonPlacementFlags="2" distUnits="MM" lineAnchorPercent="0.5" quadOffset="4" lineAnchorClipping="0" yOffset="0" centroidWhole="0" offsetType="0" repeatDistanceUnits="MM" fitInPolygonOnly="0" repeatDistance="0" placement="2" layerType="LineGeometry" preserveRotation="0" lineAnchorType="0" xOffset="0" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" geometryGenerator="" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" geometryGeneratorEnabled="0" overrunDistance="0" rotationAngle="0" maxCurvedCharAngleIn="25" priority="5" overrunDistanceUnit="MM"/>
          <rendering upsidedownLabels="0" scaleMin="1" obstacleFactor="1" drawLabels="1" displayAll="1" unplacedVisibility="0" scaleVisibility="0" obstacle="1" fontMinPixelSize="3" zIndex="0" fontLimitPixelSize="0" scaleMax="10000000" obstacleType="0" minFeatureSize="0" mergeLines="0" fontMaxPixelSize="10000" labelPerPart="0" limitNumLabels="0" maxNumLabels="2000"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
