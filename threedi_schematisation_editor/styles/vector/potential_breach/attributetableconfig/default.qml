...
<qgis><attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="initial_exchange_level" />
      <column width="-1" hidden="0" type="field" name="levee_material" />
      <column width="-1" hidden="0" type="field" name="tags" />
      <column width="-1" hidden="0" type="field" name="final_exchange_level" />
