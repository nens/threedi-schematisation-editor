            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="size">
                  ...
                  <Option type="QString" value="if(@map_scale&lt;10000, 1.2,0.7)" name="expression"/>
