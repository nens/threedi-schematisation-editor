...
<qgis><aliases>
    ...
    <alias field="tags" name="Tags" index="2" />
    <alias field="display_name" name="Display name" index="3" />
    <alias field="storage_area" name="Storage area [m²]" index="4" />
    ...
    <alias field="hydraulic_conductivity_in" name="Hydraulic conductivity in [m/d]" index="12" />
    <alias field="hydraulic_conductivity_out" name="Hydraulic conductivity out [m/d]" index="13" />
  </aliases>
  </qgis>