...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" maxScale="-4.65661e-10" labelsEnabled="1" simplifyDrawingHints="0" readOnly="0" hasScaleBasedVisibilityFlag="0" version="3.10.10-A Coruña" simplifyMaxScale="1" minScale="1e+08" simplifyLocal="1" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="id" index="1" field="id"/>
  ...
  <constraints>
    ...
    <constraint field="id" constraints="1" unique_strength="0" notnull_strength="2" exp_strength="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" name="pump point view" visibilityExpression="" groupBox="0" visibilityExpressionEnabled="0" showLabel="1">
