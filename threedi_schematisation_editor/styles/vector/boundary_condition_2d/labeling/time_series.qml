...
<qgis><labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement maxCurvedCharAngleIn="25" yOffset="0" distUnits="MM" offsetType="0" lineAnchorTextPoint="FollowPlacement" overrunDistance="0" allowDegraded="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" placementFlags="10" polygonPlacementFlags="2" geometryGeneratorEnabled="0" overrunDistanceUnit="MM" preserveRotation="1" placement="4" overlapHandling="PreventOverlap" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" rotationAngle="0" quadOffset="4" layerType="LineGeometry" rotationUnit="AngleDegrees" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" xOffset="0" lineAnchorPercent="0.5" repeatDistance="0" lineAnchorClipping="0" lineAnchorType="0" offsetUnits="MM" dist="0" priority="5" />
