...
<qgis><attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;connection_node_id&quot;">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="time_units" />
      <column width="-1" hidden="0" type="field" name="interpolate" />
