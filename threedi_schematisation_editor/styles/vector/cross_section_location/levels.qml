...
<qgis styleCategories="AllStyleCategories" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" simplifyDrawingHints="0" labelsEnabled="1" readOnly="0" version="3.28.11-Firenze" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" minScale="0" symbologyReferenceScale="-1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format multilineAlign="2" reverseDirectionSymbol="0" decimals="3" wrapChar="" formatNumbers="0" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" placeDirectionSymbol="0" autoWrapLength="0" useMaxLineLengthForAutoWrap="1"/>
      ...
      <rendering mergeLines="0" upsidedownLabels="0" scaleVisibility="1" unplacedVisibility="0" obstacle="1" zIndex="0" labelPerPart="0" maxNumLabels="2000" scaleMin="1" drawLabels="1" obstacleFactor="1" minFeatureSize="0" obstacleType="0" limitNumLabels="0" fontLimitPixelSize="0" scaleMax="5000" fontMinPixelSize="3" fontMaxPixelSize="10000"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties" type="Map">
