...
<qgis><attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="affects_2d" />
      <column width="-1" hidden="0" type="field" name="affects_1d2d_open_water" />
      <column width="-1" hidden="0" type="field" name="affects_1d2d_closed" />
