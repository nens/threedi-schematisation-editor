...
<qgis labelsEnabled="1" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" maxScale="0" symbologyReferenceScale="-1" version="3.28.5-Firenze" simplifyLocal="1" readOnly="0" simplifyDrawingTol="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement geometryGenerator="" lineAnchorPercent="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" centroidWhole="0" preserveRotation="1" yOffset="0" centroidInside="0" maxCurvedCharAngleOut="-25" rotationAngle="0" repeatDistanceUnits="MM" xOffset="0" lineAnchorType="0" quadOffset="4" overlapHandling="PreventOverlap" geometryGeneratorEnabled="0" distUnits="MM" lineAnchorClipping="0" priority="5" polygonPlacementFlags="2" layerType="PointGeometry" offsetType="0" geometryGeneratorType="PointGeometry" dist="0" placement="0" offsetUnits="MM" allowDegraded="0" placementFlags="10" lineAnchorTextPoint="CenterOfText" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0"/>
      <rendering obstacleType="0" unplacedVisibility="0" zIndex="0" fontMinPixelSize="3" scaleMin="0" limitNumLabels="0" scaleMax="0" fontMaxPixelSize="10000" minFeatureSize="0" fontLimitPixelSize="0" maxNumLabels="2000" mergeLines="0" labelPerPart="0" scaleVisibility="0" drawLabels="1" obstacleFactor="1" upsidedownLabels="0" obstacle="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
