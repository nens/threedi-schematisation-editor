...
<qgis styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms" labelsEnabled="1" readOnly="0" version="3.16.9-Hannover">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" useSubstitutions="0" fontSize="8" blendMode="0" namedStyle="Regular" isExpression="0" fontFamily="MS Gothic" textOpacity="1" fontUnderline="0" capitalization="0" allowHtml="0" fieldName="code" fontLetterSpacing="0" fontStrikeout="0" fontSizeUnit="Point" fontWordSpacing="0" fontWeight="50" textColor="0,0,0,255" fontItalic="0" previewBkgrdColor="255,255,255,255" fontKerning="1" multilineHeight="1">
      ...
      <placement distUnits="MM" offsetType="0" overrunDistance="0" lineAnchorPercent="0.5" geometryGenerator="" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" priority="5" rotationAngle="0" maxCurvedCharAngleOut="-25" maxCurvedCharAngleIn="25" offsetUnits="MM" repeatDistanceUnits="MM" lineAnchorType="0" preserveRotation="1" dist="0" placement="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" overrunDistanceUnit="MM" layerType="PointGeometry" centroidInside="0" polygonPlacementFlags="2" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" centroidWhole="0" quadOffset="4" placementFlags="10" yOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0"/>
      <rendering fontLimitPixelSize="0" maxNumLabels="2000" minFeatureSize="0" scaleMax="0" limitNumLabels="0" zIndex="0" displayAll="0" scaleVisibility="0" obstacleFactor="1" labelPerPart="0" fontMinPixelSize="3" obstacleType="0" fontMaxPixelSize="10000" obstacle="1" upsidedownLabels="0" scaleMin="0" mergeLines="0" drawLabels="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
