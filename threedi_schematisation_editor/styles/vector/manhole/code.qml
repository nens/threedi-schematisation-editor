...
<qgis maxScale="0" symbologyReferenceScale="-1" labelsEnabled="1" simplifyDrawingTol="1" simplifyDrawingHints="0" version="3.28.5-Firenze" simplifyMaxScale="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" readOnly="0" simplifyLocal="1" minScale="0">
  <flags>
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer">
    <rules key="{4fbba513-a3b1-4a92-97bc-3d44735ac986}">
      <rule key="{a951db60-faa9-4c95-9eaa-a51d84ff90b1}" filter="manhole_indicator = 0" symbol="0" label="Manhole (inspection)"/>
      <rule key="{c9e7ab73-45d5-45d6-970d-b4e28230c1e5}" filter="manhole_indicator = 1" symbol="1" label="Outlet"/>
      <rule key="{a1d98efc-8098-4201-a75e-93dc7c47f076}" filter="manhole_indicator = 2" symbol="2" label="Pumping station"/>
      <rule key="{1b6d21ed-8a83-4e3f-850e-ca64e766f7da}" filter="ELSE" symbol="3" label="Manhole (unspecified)"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style multilineHeight="1" fontItalic="0" multilineHeightUnit="Percentage" previewBkgrdColor="255,255,255,255" textOpacity="1" namedStyle="Regular" useSubstitutions="0" textColor="0,0,0,255" blendMode="0" fontSizeUnit="Point" fieldName="code" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" fontSize="8" fontLetterSpacing="0" forcedBold="0" isExpression="0" fontKerning="1" fontWordSpacing="0" legendString="Aa" fontFamily="MS Gothic" fontWeight="50" forcedItalic="0" fontUnderline="0" fontStrikeout="0" allowHtml="0" capitalization="0">
        <families/>
        <text-buffer bufferDraw="1" bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255" bufferSize="0.69999999999999996" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1"/>
      ...
      <text-format addDirectionSymbol="0" formatNumbers="0" autoWrapLength="0" rightDirectionSymbol=">" plussign="0" multilineAlign="3" wrapChar="" reverseDirectionSymbol="0" placeDirectionSymbol="0" decimals="3" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;"/>
      <placement priority="5" lineAnchorPercent="0.5" rotationUnit="AngleDegrees" placementFlags="10" overrunDistance="0" lineAnchorType="0" geometryGeneratorType="PointGeometry" centroidInside="0" layerType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" lineAnchorTextPoint="CenterOfText" placement="0" distUnits="MM" fitInPolygonOnly="0" quadOffset="4" xOffset="0" geometryGenerator="" offsetType="0" polygonPlacementFlags="2" repeatDistance="0" allowDegraded="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" offsetUnits="MM" maxCurvedCharAngleOut="-25" rotationAngle="0" overlapHandling="PreventOverlap" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorClipping="0" geometryGeneratorEnabled="0" yOffset="0" repeatDistanceUnits="MM" centroidWhole="0" preserveRotation="1"/>
      <rendering labelPerPart="0" limitNumLabels="0" scaleVisibility="0" minFeatureSize="0" maxNumLabels="2000" obstacleType="0" scaleMin="0" mergeLines="0" drawLabels="1" scaleMax="0" upsidedownLabels="0" unplacedVisibility="0" fontMinPixelSize="3" obstacleFactor="1" zIndex="0" fontLimitPixelSize="0" obstacle="1" fontMaxPixelSize="10000"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
