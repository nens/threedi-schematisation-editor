...
<qgis readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.22.10-Białowieża" maxScale="0" simplifyDrawingHints="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" minScale="0" simplifyLocal="1" labelsEnabled="1">
  <flags>
  ...
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{4fbba513-a3b1-4a92-97bc-3d44735ac986}">
      <rule symbol="0" filter="manhole_indicator = 0" key="{a951db60-faa9-4c95-9eaa-a51d84ff90b1}" label="Manhole (inspection)"/>
      <rule symbol="1" filter="manhole_indicator = 1" key="{c9e7ab73-45d5-45d6-970d-b4e28230c1e5}" label="Outlet"/>
      <rule symbol="2" filter="manhole_indicator = 2" key="{a1d98efc-8098-4201-a75e-93dc7c47f076}" label="Pumping station"/>
      <rule symbol="3" filter="ELSE" key="{1b6d21ed-8a83-4e3f-850e-ca64e766f7da}" label="Manhole (unspecified)"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontFamily="MS Gothic" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWeight="50" textOrientation="horizontal" fontItalic="0" isExpression="0" textColor="0,0,0,255" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fieldName="code" textOpacity="1" fontWordSpacing="0" useSubstitutions="0" multilineHeight="1" capitalization="0" fontLetterSpacing="0" namedStyle="Regular" fontSize="8" fontKerning="1" fontSizeUnit="Point" blendMode="0" fontStrikeout="0" allowHtml="0">
        <families/>
        <text-buffer bufferDraw="1" bufferJoinStyle="128" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferSize="0.69999999999999996"/>
        <text-mask maskSize="0" maskJoinStyle="128" maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskType="0" maskEnabled="0" maskSizeUnits="MM" maskedSymbolLayers=""/>
        <background shapeSVGFile="" shapeRotation="0" shapeBlendMode="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeRotationType="0" shapeDraw="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeSizeUnit="MM" shapeType="0" shapeBorderWidth="0" shapeSizeType="0" shapeOffsetUnit="MM" shapeSizeY="0" shapeOffsetY="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeBorderColor="128,128,128,255" shapeOpacity="1" shapeOffsetX="0" shapeRadiiUnit="MM" shapeRadiiX="0">
        ...
        <shadow shadowOffsetAngle="135" shadowOffsetDist="1" shadowUnder="0" shadowRadiusAlphaOnly="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowScale="100" shadowOpacity="0.69999999999999996" shadowOffsetUnit="MM" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowRadius="1.5" shadowColor="0,0,0,255" shadowOffsetGlobal="1" shadowRadiusUnit="MM" shadowBlendMode="6" shadowDraw="0"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format decimals="3" formatNumbers="0" multilineAlign="3" reverseDirectionSymbol="0" addDirectionSymbol="0" rightDirectionSymbol=">" wrapChar="" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" plussign="0"/>
      <placement lineAnchorType="0" distUnits="MM" dist="0" preserveRotation="1" geometryGeneratorEnabled="0" rotationAngle="0" placementFlags="10" geometryGenerator="" offsetUnits="MM" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" repeatDistanceUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" xOffset="0" priority="5" maxCurvedCharAngleOut="-25" centroidInside="0" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" layerType="PointGeometry" placement="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" offsetType="0" lineAnchorClipping="0" polygonPlacementFlags="2" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" rotationUnit="AngleDegrees" geometryGeneratorType="PointGeometry"/>
      <rendering scaleMax="0" labelPerPart="0" limitNumLabels="0" maxNumLabels="2000" zIndex="0" unplacedVisibility="0" scaleMin="0" mergeLines="0" fontMinPixelSize="3" scaleVisibility="0" minFeatureSize="0" fontLimitPixelSize="0" displayAll="0" obstacle="1" obstacleType="0" upsidedownLabels="0" drawLabels="1" obstacleFactor="1" fontMaxPixelSize="10000"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
