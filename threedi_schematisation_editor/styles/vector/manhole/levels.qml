...
<qgis labelsEnabled="1" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" maxScale="0" symbologyReferenceScale="-1" version="3.28.5-Firenze" simplifyLocal="1" readOnly="0" simplifyDrawingTol="1">
  <flags>
  ...
  <renderer-v2 forceraster="0" referencescale="-1" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{4fbba513-a3b1-4a92-97bc-3d44735ac986}">
      <rule label="Manhole (inspection)" symbol="0" key="{a951db60-faa9-4c95-9eaa-a51d84ff90b1}" filter="visualisation = 0"/>
      <rule label="Outlet" symbol="1" key="{c9e7ab73-45d5-45d6-970d-b4e28230c1e5}" filter="visualisation = 1"/>
      <rule label="Pumping station" symbol="2" key="{a1d98efc-8098-4201-a75e-93dc7c47f076}" filter="visualisation = 2"/>
      <rule label="Manhole (unspecified)" symbol="3" key="{1b6d21ed-8a83-4e3f-850e-ca64e766f7da}" filter="ELSE"/>
    </rules>
    <symbols>
      <symbol alpha="1" frame_rate="10" force_rhr="0" is_animated="0" type="marker" clip_to_extent="1" name="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" frame_rate="10" force_rhr="0" is_animated="0" type="marker" clip_to_extent="1" name="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" frame_rate="10" force_rhr="0" is_animated="0" type="marker" clip_to_extent="1" name="2">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" frame_rate="10" force_rhr="0" is_animated="0" type="marker" clip_to_extent="1" name="3">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" fontItalic="0" textOpacity="1" fontKerning="1" legendString="Aa" fontUnderline="0" multilineHeight="1" textOrientation="horizontal" fontSizeUnit="Point" fontFamily="MS Gothic" fontWordSpacing="0" forcedItalic="0" fontSize="8" multilineHeightUnit="Percentage" useSubstitutions="0" fontStrikeout="0" fontWeight="50" namedStyle="Regular" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fieldName="'s:' || coalesce(manhole_surface_level, 'NULL') || '\n' ||&#xd;&#xa;'d:' || coalesce(exchange_level, 'NULL') ||  '\n' || &#xd;&#xa;'b:' || coalesce(bottom_level, 'NULL') " allowHtml="0" forcedBold="0" fontLetterSpacing="0" isExpression="1" textColor="0,0,0,255" blendMode="0">
        <families/>
        <text-buffer bufferColor="255,255,255,255" bufferBlendMode="0" bufferSize="0.69999999999999996" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferJoinStyle="128" bufferOpacity="1" bufferDraw="1"/>
      ...
      <text-format plussign="0" placeDirectionSymbol="0" wrapChar="" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" autoWrapLength="0" multilineAlign="3" reverseDirectionSymbol="0" addDirectionSymbol="0" formatNumbers="0" decimals="3" useMaxLineLengthForAutoWrap="1"/>
      <placement geometryGenerator="" lineAnchorPercent="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" centroidWhole="0" preserveRotation="1" yOffset="-1" centroidInside="0" maxCurvedCharAngleOut="-25" rotationAngle="0" repeatDistanceUnits="MM" xOffset="1" lineAnchorType="0" quadOffset="2" overlapHandling="PreventOverlap" geometryGeneratorEnabled="0" distUnits="MM" lineAnchorClipping="0" priority="5" polygonPlacementFlags="2" layerType="PointGeometry" offsetType="0" geometryGeneratorType="PointGeometry" dist="0" placement="1" offsetUnits="MM" allowDegraded="0" placementFlags="10" lineAnchorTextPoint="CenterOfText" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0"/>
      <rendering obstacleType="0" unplacedVisibility="0" zIndex="0" fontMinPixelSize="3" scaleMin="0" limitNumLabels="0" scaleMax="1000" fontMaxPixelSize="10000" minFeatureSize="0" fontLimitPixelSize="0" maxNumLabels="2000" mergeLines="0" labelPerPart="0" scaleVisibility="1" drawLabels="1" obstacleFactor="1" upsidedownLabels="0" obstacle="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="hydraulic_conductivity_in" index="16" name=""/>
    <alias field="hydraulic_conductivity_out" index="17" name=""/>
  </aliases>
  <defaults>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" visibilityExpression="" columnCount="1" name="Manhole_view">
      <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" italic="0" strikethrough="0" bold="0" style=""/>
      </labelStyle>
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsed="0" groupBox="1" visibilityExpressionEnabled="0" visibilityExpression="" columnCount="1" name="Characteristics">
        ...
        <attributeEditorField showLabel="1" index="6" name="width">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" italic="0" strikethrough="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField showLabel="1" index="7" name="length">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" italic="0" strikethrough="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField showLabel="1" index="8" name="bottom_level">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" italic="0" strikethrough="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsed="0" groupBox="1" visibilityExpressionEnabled="0" visibilityExpression="" columnCount="1" name="Visualisation">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" italic="0" strikethrough="0" bold="0" style=""/>
        </labelStyle>
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsed="0" groupBox="1" visibilityExpressionEnabled="0" visibilityExpression="" columnCount="1" name="Connection node">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" italic="0" strikethrough="0" bold="0" style=""/>
        </labelStyle>
        ...
        <attributeEditorField showLabel="1" index="-1" name="node_code">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" italic="0" strikethrough="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField showLabel="1" index="-1" name="node_initial_waterlevel">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" italic="0" strikethrough="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField showLabel="1" index="-1" name="node_storage_area">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" italic="0" strikethrough="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
