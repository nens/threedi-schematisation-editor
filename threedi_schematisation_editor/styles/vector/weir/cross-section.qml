...
<qgis simplifyMaxScale="1" maxScale="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" version="3.22.6-Białowieża" simplifyAlgorithm="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" labelsEnabled="1" readOnly="0" minScale="0" simplifyDrawingHints="1">
  ...
  <renderer-v2 enableorderby="0" referencescale="-1" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedSize" attr="coalesce(cross_section_max_width(cross_section_shape, cross_section_width, cross_section_table), 1)" forceraster="0">
    <ranges>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" fontItalic="0" fontSize="7" forcedItalic="0" previewBkgrdColor="255,255,255,255" fontStrikeout="0" isExpression="1" textColor="227,26,28,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontKerning="1" fontWordSpacing="0" fieldName="cross_section_label(cross_section_shape, cross_section_width, cross_section_height, cross_section_table, 'm', True)" namedStyle="Regular" fontWeight="50" forcedBold="0" allowHtml="0" capitalization="0" useSubstitutions="0" fontFamily="MS Gothic" fontLetterSpacing="0" legendString="Aa" fontSizeUnit="Point" multilineHeightUnit="Percentage" textOpacity="1" blendMode="0" textOrientation="horizontal" multilineHeight="1">
        <families/>
      ...
      <text-format wrapChar="" multilineAlign="1" addDirectionSymbol="0" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" autoWrapLength="0" rightDirectionSymbol=">" formatNumbers="0" decimals="3" plussign="0" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0"/>
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorClipping="0" lineAnchorType="0" offsetType="0" fitInPolygonOnly="0" offsetUnits="MapUnit" polygonPlacementFlags="2" geometryGenerator="" allowDegraded="0" lineAnchorPercent="0.5" overrunDistance="30" layerType="LineGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorTextPoint="StartOfText" distUnits="MM" preserveRotation="1" geometryGeneratorType="PointGeometry" maxCurvedCharAngleOut="-25" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" repeatDistance="0" quadOffset="4" priority="5" overlapHandling="PreventOverlap" placement="4" maxCurvedCharAngleIn="25" centroidWhole="0" overrunDistanceUnit="MM" placementFlags="9" geometryGeneratorEnabled="0" repeatDistanceUnits="MM" yOffset="0" dist="0" rotationUnit="AngleDegrees" centroidInside="0"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="3: Broad crested" type="int" value="3"/>
              </Option>
              <Option type="Map">
                <Option name="4: Short crested" type="int" value="4"/>
              </Option>
            </Option>
          </Option>
        </config>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="0: Lowest visibility" type="int" value="0"/>
              </Option>
              <Option type="Map">
                <Option name="1: Low visibility" type="int" value="1"/>
              </Option>
              <Option type="Map">
                <Option name="2: Medium low visibility" type="int" value="2"/>
              </Option>
              <Option type="Map">
                <Option name="3: Medium visibility" type="int" value="3"/>
              </Option>
              <Option type="Map">
                <Option name="4: High visibility" type="int" value="4"/>
              </Option>
              <Option type="Map">
                <Option name="5: Highest visibility" type="int" value="5"/>
              </Option>
            </Option>
          </Option>
        </config>
