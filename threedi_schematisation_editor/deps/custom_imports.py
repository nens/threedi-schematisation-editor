...
REQUIRED_3DI_SCHEMA_VERSION = "0.300.20"
...
REQUIRED_TYPING_EXTENSIONS_VERSION = "4.12.2"
...
def patch_wheel_imports():
    ...
    """
    requirements = [
        (TYPING_EXTENSIONS_MODULE_NAME, REQUIRED_TYPING_EXTENSIONS_VERSION, TYPING_EXTENSIONS_WHEEL),
