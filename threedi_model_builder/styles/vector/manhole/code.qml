...
<qgis styleCategories="Symbology|Labeling|Forms|MapTips" labelsEnabled="1" version="3.16.9-Hannover">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <rendering zIndex="0" drawLabels="1" upsidedownLabels="0" displayAll="0" obstacle="1" scaleMax="0" scaleVisibility="0" mergeLines="0" minFeatureSize="0" obstacleType="0" labelPerPart="0" fontLimitPixelSize="0" obstacleFactor="1" fontMinPixelSize="3" fontMaxPixelSize="10000" maxNumLabels="2000" limitNumLabels="0" scaleMin="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option name="properties"/>
