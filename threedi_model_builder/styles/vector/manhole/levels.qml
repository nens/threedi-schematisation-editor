...
<qgis styleCategories="Symbology|Labeling|Forms|MapTips" labelsEnabled="1" version="3.16.9-Hannover">
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{4fbba513-a3b1-4a92-97bc-3d44735ac986}">
      <rule scalemaxdenom="5000" filter="manhole_indicator = 0" key="{a951db60-faa9-4c95-9eaa-a51d84ff90b1}" label="Manhole (inspection)" scalemaxdenom="5000" symbol="0"/>
      <rule scalemaxdenom="15000" filter="manhole_indicator = 1" key="{c9e7ab73-45d5-45d6-970d-b4e28230c1e5}" label="Outlet" scalemaxdenom="15000" symbol="1"/>
      <rule filter="manhole_indicator = 2" key="{a1d98efc-8098-4201-a75e-93dc7c47f076}" label="Pumping station" symbol="2"/>
      <rule scalemaxdenom="5000" filter="ELSE" key="{1b6d21ed-8a83-4e3f-850e-ca64e766f7da}" label="Manhole (unspecified)" scalemaxdenom="5000" symbol="3"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement offsetUnits="MM" polygonPlacementFlags="2" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" lineAnchorType="0" placement="1" preserveRotation="1" overrunDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" centroidInside="0" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" yOffset="-1" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" overrunDistanceUnit="MM" distUnits="MM" geometryGenerator="" xOffset="1" quadOffset="2" layerType="PointGeometry" lineAnchorPercent="0.5" placementFlags="10" geometryGeneratorType="PointGeometry"/>
