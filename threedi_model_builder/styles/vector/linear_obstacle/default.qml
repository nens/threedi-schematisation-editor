...
<qgis simplifyAlgorithm="0" minScale="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="3.16.3-Hannover" labelsEnabled="0" readOnly="0" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories" simplifyDrawingHints="1">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{5c137023-c26c-4bdc-a061-eb42f465b888}">
      <rule key="{ac149572-23d5-4201-b5df-8bd99f68cd02}" filter="&quot;type&quot; = 1" label="Levee (can be breached)" symbol="0">
        <rule key="{97978e62-9acb-406c-a02c-994f15a3ef41}" filter="&quot;material&quot; = '1'" label="Sand" symbol="1"/>
        <rule key="{2a46eb17-9e65-4e99-8d97-acff877b0d30}" filter="&quot;material&quot; = '2'" label="Clay" symbol="2"/>
        <rule key="{10e437a6-5370-412d-bd43-a0e9b56d429e}" filter="&quot;material&quot; = ''" label="NULL or other material" symbol="3"/>
      </rule>
      <rule key="{2d08e581-71ac-46b9-ae42-324d43c90558}" filter="&quot;type&quot; = 0" label="Other (cannot be breached" symbol="4"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" force_rhr="0" type="line" name="1" clip_to_extent="1">
        ...
        <layer class="HashLine" enabled="1" pass="0" locked="0">
          ...
          <symbol alpha="1" force_rhr="0" type="line" name="@1@1" clip_to_extent="1">
            <layer class="SimpleLine" enabled="1" pass="0" locked="0">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
      ...
      <symbol alpha="1" force_rhr="0" type="line" name="2" clip_to_extent="1">
        ...
        <layer class="HashLine" enabled="1" pass="0" locked="0">
          ...
          <symbol alpha="1" force_rhr="0" type="line" name="@2@1" clip_to_extent="1">
            <layer class="SimpleLine" enabled="1" pass="0" locked="0">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
        ...
        <layer class="HashLine" enabled="1" pass="0" locked="0">
          ...
          <symbol alpha="1" force_rhr="0" type="line" name="@2@2" clip_to_extent="1">
            <layer class="SimpleLine" enabled="1" pass="0" locked="0">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option value="0" type="QString" name="Other (cannot be breached"/>
              </Option>
              <Option type="Map">
                <Option value="1" type="QString" name="Levee (can be breached)"/>
              </Option>
            </Option>
          </Option>
        </config>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option value="1" type="QString" name="1: sand"/>
              </Option>
              <Option type="Map">
                <Option value="2" type="QString" name="2: clay"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="crest_level" index="4" name=""/>
    <alias field="material" index="5" name=""/>
    <alias field="max_breach_depth" index="6" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint constraints="1" exp_strength="0" notnull_strength="1" field="type" unique_strength="0"/>
    <constraint constraints="1" exp_strength="0" notnull_strength="2" field="crest_level" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" field="material" unique_strength="0"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" field="max_breach_depth" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="max_breach_depth"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" groupBox="0" visibilityExpression="" columnCount="1" name="General" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField showLabel="1" index="4" name="crest_level"/>
      <attributeEditorField showLabel="1" index="5" name="material"/>
      <attributeEditorField showLabel="1" index="6" name="max_breach_depth"/>
