...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1" readOnly="0" maxScale="0" version="3.10.10-A Coruña" labelsEnabled="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement placement="1" offsetType="0" yOffset="1" dist="0" offsetUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" repeatDistance="0" xOffset="1" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" centroidInside="0" distUnits="MM" layerType="LineGeometry" priority="5" preserveRotation="1" overrunDistance="0" overrunDistanceUnit="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" geometryGenerator="start_point($geometry)" placementFlags="9" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" quadOffset="8" geometryGeneratorEnabled="1"/>
  ...
  <DiagramLayerSettings dist="0" obstacle="0" zIndex="0" placement="2" showAll="1" linePlacementFlags="18" priority="0">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="2" name="display_name" field="display_name"/>
    <alias index="3" name="code" field="code"/>
    <alias index="4" name="classification" field="classification"/>
    <alias index="5" name="type" field="type"/>
    <alias index="6" name="sewerage" field="sewerage"/>
    <alias index="7" name="start_level" field="start_level"/>
    <alias index="8" name="lower_stop_level" field="lower_stop_level"/>
    <alias index="9" name="upper_stop_level" field="upper_stop_level"/>
    <alias index="10" name="capacity" field="capacity"/>
    <alias index="11" name="zoom_category" field="zoom_category"/>
    <alias index="12" name="connection_node_start_id" field="connection_node_start_id"/>
    <alias index="13" name="connection_node_end_id" field="connection_node_end_id"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="if(aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,start_point(geometry(@parent)))) is null,'Created automatically',aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,start_point(geometry(@parent)))))" applyOnUpdate="0" field="connection_node_start_id"/>
    <default expression="if(aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,end_point(geometry(@parent)))) is null,'Created automatically',aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,end_point(geometry(@parent)))))" applyOnUpdate="0" field="connection_node_end_id"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="ROWID"/>
    <constraint notnull_strength="2" constraints="1" unique_strength="0" exp_strength="0" field="id"/>
    <constraint notnull_strength="2" constraints="1" unique_strength="0" exp_strength="0" field="display_name"/>
    <constraint notnull_strength="2" constraints="1" unique_strength="0" exp_strength="0" field="code"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="classification"/>
    <constraint notnull_strength="2" constraints="1" unique_strength="0" exp_strength="0" field="type"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="sewerage"/>
    <constraint notnull_strength="2" constraints="1" unique_strength="0" exp_strength="0" field="start_level"/>
    <constraint notnull_strength="2" constraints="5" unique_strength="0" exp_strength="2" field="lower_stop_level"/>
    <constraint notnull_strength="0" constraints="4" unique_strength="0" exp_strength="2" field="upper_stop_level"/>
    <constraint notnull_strength="2" constraints="5" unique_strength="0" exp_strength="2" field="capacity"/>
    <constraint notnull_strength="2" constraints="1" unique_strength="0" exp_strength="0" field="zoom_category"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="connection_node_start_id"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0" field="connection_node_end_id"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" exp="&quot;upper_stop_level&quot;>&quot;start_level&quot; or &quot;upper_stop_level&quot; is null" field="upper_stop_level"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer groupBox="0" visibilityExpression="" showLabel="1" visibilityExpressionEnabled="0" columnCount="1" name="Pumpstation view">
