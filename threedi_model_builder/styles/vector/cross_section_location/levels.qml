...
<qgis version="3.16.9-Hannover" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms" labelsEnabled="1" readOnly="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" isExpression="1" namedStyle="Regular" fontStrikeout="0" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fontWordSpacing="0" useSubstitutions="0" fontKerning="1" fontUnderline="0" fontSize="7" multilineHeight="1" blendMode="0" fieldName="'bank: '|| coalesce(format_number(bank_level, 2),'NULL')|| '\n'  || &#xd;&#xa;'ref:'|| coalesce(format_number(reference_level, 2),'NULL') ||'\n'  || &#xd;&#xa;'diff:'|| coalesce(format_number(bank_level - reference_level, 2),'NULL')&#xd;&#xa;" fontSizeUnit="Point" textOrientation="horizontal" capitalization="0" fontFamily="MS Gothic" fontWeight="50" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" textOpacity="1" fontItalic="0">
      ...
      <text-format useMaxLineLengthForAutoWrap="1" autoWrapLength="0" addDirectionSymbol="0" wrapChar="" decimals="3" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" multilineAlign="2" plussign="0" reverseDirectionSymbol="0" placeDirectionSymbol="0" formatNumbers="0"/>
      ...
      <rendering fontMinPixelSize="3" upsidedownLabels="0" scaleMax="5000" obstacle="1" fontMaxPixelSize="10000" scaleVisibility="1" zIndex="0" scaleMin="1" obstacleFactor="1" fontLimitPixelSize="0" displayAll="0" maxNumLabels="2000" minFeatureSize="0" drawLabels="1" mergeLines="0" obstacleType="0" labelPerPart="0" limitNumLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option type="Map" name="properties">
