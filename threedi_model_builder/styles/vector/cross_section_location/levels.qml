...
<qgis readOnly="0" simplifyLocal="1" labelsEnabled="1" simplifyDrawingTol="1" version="3.10.10-A Coruña" simplifyAlgorithm="0" minScale="1e+08" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingHints="0" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias name="bank_level" field="bank_level" index="4"/>
    <alias name="friction_type" field="friction_type" index="5"/>
    <alias name="friction_value" field="friction_value" index="6"/>
    <alias name="definition_id" field="definition_id" index="7"/>
    <alias name="channel_id" field="channel_id" index="8"/>
    <alias name="" field="cross_section_definition_id" index="9"/>
    <alias name="" field="cross_section_definition_shape" index="10"/>
    <alias name="" field="cross_section_definition_width" index="11"/>
    <alias name="" field="cross_section_definition_code" index="12"/>
    <alias name="" field="cross_section_definition_height" index="13"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="definition_id" expression=""/>
    ...
    <default applyOnUpdate="0" field="cross_section_definition_code" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="1" field="id" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="code" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="reference_level" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="bank_level" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="friction_type" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="friction_value" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="definition_id" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="channel_id" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="cross_section_definition_id" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="cross_section_definition_shape" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="cross_section_definition_width" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="cross_section_definition_code" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="cross_section_definition_height" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" field="definition_id" exp=""/>
    <constraint desc="" field="channel_id" exp=""/>
    <constraint desc="" field="cross_section_definition_id" exp=""/>
    <constraint desc="" field="cross_section_definition_shape" exp=""/>
    <constraint desc="" field="cross_section_definition_width" exp=""/>
    <constraint desc="" field="cross_section_definition_code" exp=""/>
    <constraint desc="" field="cross_section_definition_height" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
