...
<qgis labelsEnabled="0" readOnly="0" version="3.16.3-Hannover" styleCategories="LayerConfiguration|Symbology|Labeling|Forms">
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" groupBox="0" visibilityExpression="" name="Orifice view" showLabel="1" visibilityExpressionEnabled="0">
      <attributeEditorContainer columnCount="1" groupBox="1" visibilityExpression="" name="General" showLabel="1" visibilityExpressionEnabled="0">
        ...
        <attributeEditorField name="orf_display_name" showLabel="1" index="-1"/>
        <attributeEditorField name="orf_code" showLabel="1" index="-1"/>
      ...
      <attributeEditorContainer columnCount="1" groupBox="1" visibilityExpression="" name="Characteristics" showLabel="1" visibilityExpressionEnabled="0">
        <attributeEditorField name="orf_crest_level" showLabel="1" index="-1"/>
        <attributeEditorField name="orf_crest_type" showLabel="1" index="-1"/>
        <attributeEditorField name="orf_friction_value" showLabel="1" index="-1"/>
        <attributeEditorField name="orf_friction_type" showLabel="1" index="-1"/>
        <attributeEditorField name="orf_discharge_coefficient_positive" showLabel="1" index="-1"/>
        <attributeEditorField name="orf_discharge_coefficient_negative" showLabel="1" index="-1"/>
        <attributeEditorField name="orf_max_capacity" showLabel="1" index="-1"/>
      </attributeEditorContainer>
      <attributeEditorContainer columnCount="1" groupBox="1" visibilityExpression="" name="Visualization" showLabel="1" visibilityExpressionEnabled="0">
        <attributeEditorField name="orf_sewerage" showLabel="1" index="-1"/>
        <attributeEditorField name="orf_zoom_category" showLabel="1" index="-1"/>
      </attributeEditorContainer>
      <attributeEditorContainer columnCount="1" groupBox="1" visibilityExpression="" name="Cross section" showLabel="1" visibilityExpressionEnabled="0">
        <attributeEditorField name="orf_cross_section_definition_id" showLabel="1" index="-1"/>
      ...
      <attributeEditorContainer columnCount="1" groupBox="1" visibilityExpression="" name="Connection nodes" showLabel="1" visibilityExpressionEnabled="0">
        <attributeEditorField name="orf_connection_node_start_id" showLabel="1" index="-1"/>
        <attributeEditorField name="orf_connection_node_end_id" showLabel="1" index="-1"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
